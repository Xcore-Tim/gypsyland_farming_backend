...
func (srvc TeamAccessServiceImpl) GetAllAccesses() ([]*teams.TeamAccess, error) {

	var teamAccesses []*teams.TeamAccess
...
func (srvc TeamAccessServiceImpl) GetFarmersAccesses(farmerAccesses *[]teams.FarmerAccess, userData *auth.UserData) error {
...
func (srvc TeamAccessServiceImpl) GetAccess(farmer int) (*teams.TeamAccess, error) {
...
func (srvc TeamAccessServiceImpl) GetAccessByNum(teamAccess *teams.TeamAccess, farmerID int) error {

	var access teams.TeamAccess
...
func (srvc TeamAccessServiceImpl) CheckAccess(employee int) (*teams.TeamAccess, error) {
	...
	if err != nil {
		var newAccess teams.TeamAccess
...
func (srvc TeamAccessServiceImpl) UpdateAccess(teamAccess *teams.TeamAccess) {
